      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-5xl max-h-[90vh] overflow-hidden my-8">
        ...
        <div className={`bg-gradient-to-r ${coresTema.gradient} p-6 relative`}>
          ...
          <div className="text-white">
            <h2 className="text-3xl font-bold mb-2">Editar Template da Anamnese</h2>
            <p className="text-sm opacity-90">
              Personalize as perguntas para este cliente específico. Essas alterações só valem para esta anamnese.
            </p>
          </div>
        </div>
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-220px)]">
          <div className="mb-6 p-4 bg-blue-50 border-2 border-blue-200 rounded-xl">
            ...
            <p className="text-sm text-blue-700">
              Você pode adicionar, remover ou reordenar perguntas. Marque como "obrigatória" as perguntas essenciais.
            </p>
          </div>
